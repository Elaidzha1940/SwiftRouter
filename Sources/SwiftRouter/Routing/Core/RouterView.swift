...
public struct RouterView<Content: View>: View, Router {
    ...
    @State private var modalBCColor: Color = Color.black.opacity(0.5)
    ...
    public var body: some View {
        ...
        .modalViewModifier(bcColor: modalBCColor, transition: modalTransition, screen: $modal)
    ...
    public func showModal<T: View>(bcColor: Color, transition: AnyTransition, @ViewBuilder destination: @escaping () -> T) {
        self.modalBCColor = bcColor
